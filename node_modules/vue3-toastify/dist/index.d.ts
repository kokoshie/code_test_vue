...
declare function unmountContainer(containerId: Id, withAnimation?: boolean): void;
declare function unmountAllContainer(): void;
declare function addExitAnimateToNode(item: ToastOptions): void;
...
export { AnimationStep, Bounce, BuiltInIconProps, CSSTransitionProps, CloseBtnType, CloseButtonProps, Content, Data, Event, EventManager, Flip, IconProps, IconType, Id, OnUpdateCallback, Options, Slide, Toast, ToastClassName, ToastContainerOptions, ToastContent, ToastContentProps, ToastFunc, ToastItemStatus, ToastMap, ToastOptions, ToastPosition, ToastProps, ToastTheme, ToastTransition, ToastType, ToastifyContainer, UpdateOptions, Zoom, addExitAnimateToNode, addOne, cacheRenderInstance, clearAll, containerInstances, Vue3Toastify as default, eventManager, getAllToast, getContainerId, getToast, globalOptions, removeOne, toast, toastMap, unmountAllContainer, unmountContainer, updateGlobalOptions, updateToast, useCssTransition, useToastContainer };
