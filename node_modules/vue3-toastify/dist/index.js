...
function getCallbackProps(opts) {
  var _a;
  const result = (0, import_vue.isVNode)(opts.content) ? (0, import_vue.toRaw)(opts.content.props) : null;
  return result != null ? result : (0, import_vue.toRaw)((_a = opts.data) != null ? _a : {});
}
...
function useCssTransition(props3) {
  ...
  (0, import_vue2.onMounted)(onEnterHandler);
...
function unmountContainer(containerId) {
  let withAnimation = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
...
function addExitAnimateToNode(item) {
